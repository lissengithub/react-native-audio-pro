...
const internalStore = exports.internalStore = (0, _zustand.create)((set, get) => ({
  ...
  updateFromEvent: event => {
    ...
    if (payload?.bufferedPosition !== undefined && payload.bufferedPosition !== current.bufferedPosition) {
    ...
    if (track) {
      ...
      const eventSignalsTrackSwap = type === _values.AudioProEventType.STATE_CHANGED && (payload?.state === _values.AudioProState.LOADING || payload?.state === _values.AudioProState.PLAYING);
